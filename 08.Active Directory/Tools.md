...
| [Kerbrute](https://github.com/ropnop/kerbrute)<br>[Kerbrute.exe](https://github.com/ropnop/kerbrute/releases/download/v1.0.3/kerbrute_windows_amd64.exe)                             |
...
| [CrackMapExec (CME) / NetExec](https://github.com/byt3bl33d3r/CrackMapExec)<br>[NetExec.exe](https://github.com/Pennyw0rth/NetExec/releases/download/v1.5.0/nxc-windows-latest.zip ) |
